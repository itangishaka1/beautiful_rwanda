    ...
    <section className="about">
      ...
      <div className="row">
        <div className="col-1-of-2">
          <h3 className="about__subheading u-margin-bottom-small">
        ...
        <div className="col-1-of-2">
          <div className="composition">
            <img src={Photo1} alt="Nyungwe forest" className="composition__photo composition__photo--p1" />
            <img src={Photo2} alt="National akagera park" className="composition__photo composition__photo--p2" />
            <img src={Photo3} alt="Kinigi gorillas park" className="composition__photo composition__photo--p3" />
          </div>
        </div>
      </div>
    </section>
